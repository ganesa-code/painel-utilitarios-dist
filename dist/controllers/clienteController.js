...
var ClientesController = /** @class */ (function () {
    function ClientesController() {
        ...
        this.getAllProdutos = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var search, query, db, clientes, parsedClientes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        clientes = _a.sent();
                        parsedClientes = firebirdService.parsedFirebirdData(clientes);
                        return [2 /*return*/, res.status(201).json({ status: "ok", parsedClientes: parsedClientes })];
                }
            });
        }); };
    }
